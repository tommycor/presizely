 ...
 */
class User extends \Presizely\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Presizely\\UserBundle\\Entity\\User' . "\0" . 'measurement', '' . "\0" . 'Presizely\\UserBundle\\Entity\\User' . "\0" . 'sexe', 'date_creation', '' . "\0" . 'Presizely\\UserBundle\\Entity\\User' . "\0" . 'histories', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addHistory(\Presizely\UserBundle\Entity\History $histories)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addHistory', array($histories));

        return parent::addHistory($histories);
    }
    ...
    public function removeHistory(\Presizely\UserBundle\Entity\History $histories)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeHistory', array($histories));

        return parent::removeHistory($histories);
    }
