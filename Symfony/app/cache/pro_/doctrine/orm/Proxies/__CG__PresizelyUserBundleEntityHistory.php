 ...
 */
class History extends \Presizely\UserBundle\Entity\History implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Presizely\\UserBundle\\Entity\\History' . "\0" . 'id', '' . "\0" . 'Presizely\\UserBundle\\Entity\\History' . "\0" . 'grade', 'date', 'user', 'article');
        }
